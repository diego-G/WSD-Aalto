...
import openid   
from twisted.test.test_failure import FailureTestCase
...
def begin(request, redirect_to=None, on_failure=None):
    print 'okkk'
    ...
    if not user_url:
        ...
        return render("django_openid_consumer/openid_signin.html", {
            'action': request_path,
...
def complete(request, on_success=None, on_failure=None):
    failure_template = 'django_openid_consumer/openid_failure.html'
